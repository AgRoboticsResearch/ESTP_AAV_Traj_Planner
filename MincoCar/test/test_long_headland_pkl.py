...
if __name__ == "__main__":
    ...
    pkl_path = os.path.join(os.path.dirname(__file__), "long_headland.pkl")
    ...
    feature_map = FeatureMap2D(x_min=117, x_max=147, y_min=86, y_max=116)
    ...
    start_state = np.array([129.42, 112.96, 0, 0])
    end_state = np.array([138.0, 88.88, np.pi, 0])
